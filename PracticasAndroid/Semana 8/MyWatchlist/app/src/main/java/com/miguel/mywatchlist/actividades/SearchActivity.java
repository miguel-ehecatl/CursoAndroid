...
public class SearchActivity extends AppCompatActivity {
    ...
    private void setAdapter(final ArrayList<Result> respuesta){
        listViewAdapter = new ListViewAdapter(respuesta,
                SearchActivity.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.d("SearchActivity","Clic al elemento"+position);

                Intent verDetalle = new Intent(SearchActivity.this,DetalleActivity.class);
                Bundle args = new Bundle();
                args.putParcelable("pelicula_seleccionada",respuesta.get(position));
                verDetalle.putExtras(args);
